...
private:
	...
	vector<vector<Room>> room_vector;
	...
	// creation of wumpus object
	wumpus wumpus_location;

	bool wumpus_is_dead = false;
	// bool wumpus_is_also_dead = true;
...
public:
	...
	/*
	 * Function: create_rand_height
	 * Description: Creates a random number in between 0 and the height of the gameboard
	 * Returns:
	 * 		random_height (int): The random number that was generated
	 */
	int create_rand_height();

	/*
	 * Function: create_rand_width
	 * Description: Creates a random number in between 0 and the width of the gameboard
	 * Returns:
	 * 		random_width (int): The random number that was generated
	 */
	int create_rand_width();

	/*
	 * Function: create_events
	 * Description: Creates and initalizes a new vector of event pointers to new event
	 * 				objects. It then creates a random height and width and if the 
	 * 				original room vector at that height and width is a nullpointer it
	 * 				adds the elements of event vector into the room vector and deletes
	 * 				it from the event vector. If it isn't a null pointer it generates a
	 * 				new random height and width.
	 */
	void create_events();

	/*
	 * Function: print_percepts
	 * Description: Takes the players location and checks to see if there is any events
	 * 				around them. If there is then it prints out the percept of the events
	 */
	void print_percepts();
